...
const TxtImgSection = () => {
  return (
    <div className='flex flex-wrap justify-center items-center my-5'>
        <img className='w-[95%] max-w-[400px] p-2' src={assets.frame1} alt="avatar" />
        <div className='md:flex-grow flex flex-col items-center max-w-[600px] w-full p-3 md:px-10 mx-5'>
            <h2 className='max-w-[600px] capitalize text-3xl md:text-4xl text-gray-700 font-bold'>Enhance Shop management smoother and more efficient</h2>
