        ...
        <div className='md:flex-grow flex flex-col items-center md:w-1/2 max-w-[400px] w-full p-3 md:px-10 mx-5'>
            ...
            <ul className='max-w-96 w-full self-start flex justify-between items-stretch my-4 '>
                <li className='flex-grow flex-shrink w-40 p-1'>
                    ...
                    <h4 className='capitalize text-gray-600 font-medium text-sm lg:text-xl'> Smooth payment</h4>
                    <p className='w-40 text-xs text-gray-500'>Duis aute irure dolor in velit reprehenderit in voluptate</p>
                </li>
                <li className='flex-grow flex-shrink w-40 p-1'>
                    <p className='py-2 w-10 h-6 bg-red-800 rounded-md my-2'></p>
                    <h4 className='capitalize text-gray-600 font-medium text-sm lg:text-xl'> convenient</h4>
                    <p className='w-40 text-xs text-gray-500'>Duis aute irure dolor in velit reprehenderit in voluptate</p>
                </li>
            </ul>
        </div>
