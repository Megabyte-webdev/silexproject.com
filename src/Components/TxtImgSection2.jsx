  ...
  return (
    <div className='flex flex-wrap justify-center items-center my-5'>
        <div className='first-line:md:flex-grow flex flex-col items-center md:w-1/2 max-w-[600px] w-full p-3 md:px-10 mx-5'>
            <h2 className='w-full capitalize text-3xl lg:text-4xl text-gray-700 font-bold'>Elevate your pos exerience with personalized reports</h2>
        ...
        <img className='h-20 mt-10 mx-2 self-start' src={assets.chatTrans} alt="chat translation" />
        </div>
