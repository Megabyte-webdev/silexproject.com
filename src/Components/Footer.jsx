    ...
    <div className='p-4 bg-black text-white min-h-96 w-[98%] mx-auto md:w-full'>
        ...
        <div className='h-max w-[95%] mx-auto border-b border-gray-700 py-4 my-6 flex flex-wrap justify-between items-stretch'>
            <section className='min-h-28 w-1/2 md:w-max px-4 min-w-[100px] *:block'>
                ...
                <NavLink to='/about' className='text-gray-400 text-sm my-2'>About Us</NavLink>
                <NavLink to='/features' className='text-gray-400 text-sm my-2'>Features</NavLink>
                <NavLink to='/solution' className='text-gray-400 text-sm my-2'>Solution</NavLink>
                <NavLink to='/pricing' className='text-gray-400 text-sm my-2'>Pricing</NavLink>
            </section>
