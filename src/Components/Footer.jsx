...
const Footer = () => {
  return (
    <div className='py-4 bg-black text-white min-h-96 w-[98%] mx-auto md:w-full'>
        <div className='w-[90%] mx-auto border-b-2 border-gray-400 py-4 my-6 flex flex-wrap justify-between items-end'>
            ...
            <section className='flex-grow flex flex-col justify-end h-max rounded-md md:w-max max-w-48 w-[90%] p-6 m-4 transition-all ease-in-out duration-300'>
