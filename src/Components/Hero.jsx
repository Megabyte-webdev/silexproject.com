  ...
  return (
    <div className='relative text-black h-[650px] flex flex-col items-center pt-28 *:transition-all *:ease-in-out *:duration-500'>
        ...
        <div className='absolute right-3 md:right-12 bottom-0'>
            <img className='absolute h-36 md:h-40 lg:h-[210px] top-0 bottom-0 right-0 left-0 m-auto' src={assets.iphone} alt="iphone" />
            <img className='h-72 md:h-80 lg:h-[420px]' src={assets.handHolding} alt="hand-holding" />
        </div>
        <img src={assets.payment} alt="chat translation" className='h-10 md:h-16 absolute bottom-6 left-10 md:left-20' />
    </div>
  )
}
