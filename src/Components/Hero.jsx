...
const Hero = () => {
  return (
    <div className='relative text-black h-screen flex flex-col items-center py-28'>
        <small className=''>Fully Integrated Point of-sale System</small>
        ...
        <div className='flex items-center mt-5 flex-wrap gap-5 w-fit '>
